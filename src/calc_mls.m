...
function results = calc_mls(mpc_base, contab, allowance, verbose, mpopt, mpopt_socp)
...
mpc_base.gen(:, PMAX) = Pmidpoint * (1 + allowance); % TODO rename allowance?
mpc_base.gen(:, PMIN) = Pmidpoint / (1 + allowance);
